...
def main():
    ...
    if choice == 1:
        ...
        print("================Afficher une ou des colonnes spécifiques================")
        pass
    elif choice == 3:
        ...
        print("================Afficher le taux de reussite pour les apprenants qui ont un score>=50================")
        ...
        print("================Diagramme de Camembert des modules regroupé par catégorie A, B, C et D================")
